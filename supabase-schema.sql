-- ═══════════════════════════════════════════════════════════
-- ArGen - Supabase Migration: Add Missing Columns
...
-- ═══════════════════════════════════════════════════════════
-- 🔧 ALL missing columns that the backend writes to
-- ═══════════════════════════════════════════════════════════

-- Companies (research agent + admin updates)
...
-- Users (profile fields + google OAuth)
...
ALTER TABLE system_metrics ADD COLUMN IF NOT EXISTS "metric" text;
...
CREATE INDEX IF NOT EXISTS idx_responses_user ON responses("user");
CREATE INDEX IF NOT EXISTS idx_responses_company ON responses("companyId");
