...
async function runCalibration() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        try {
            const result = await scoreResponse(testCase.scenario, testCase.promptText, testCase.modelOutput);
